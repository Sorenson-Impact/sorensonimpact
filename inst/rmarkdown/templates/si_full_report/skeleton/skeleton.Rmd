...
output:
  word_document:
    ...
    reference_docx: template_files/mystyles.docx
    fig_width: 6
    fig_height: 4
editor_options: 
...
`r include_graphics(path.expand("./template_files/SI_logo.png"))`

<br>

`r include_graphics(path.expand("./template_files/earth_map.jpeg"))`
